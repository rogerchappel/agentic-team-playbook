...
description: When agents should stop and ask before changing code.
---

Agents can inspect risky areas and propose a plan.

They should not make risky changes without explicit human approval.
